...
void init(GLFWwindow* window) {
    renderingProgram = Utils::createShaderProgram(SHADERS_DIR "GouraudShaders/vertShader.glsl", SHADERS_DIR "GouraudShaders/fragShader.glsl");
    cameraX = 0.0f;
    cameraY = 0.0f;
    cameraZ = 1.0f;
    torLocX = 0.0f;
...
void display(GLFWwindow* window, double currentTime) {
    ...
    mvMat = vMat * mMat;
    invTrMat = glm::transpose(glm::inverse(mvMat)); // 向量的变换是逆换吗?
