...
ImportedModel pyramid(RES_DIR "pyr.obj");
...
void init(GLFWwindow* window) {
    renderingProgram1 = Utils::createShaderProgram(SHADERS_DIR "vert1Shader.glsl", SHADERS_DIR "frag1Shader.glsl");
    renderingProgram2 = Utils::createShaderProgram(SHADERS_DIR "vert2Shader.glsl", SHADERS_DIR "frag2Shader.glsl");
