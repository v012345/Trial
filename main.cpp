...
void init(GLFWwindow* window) {
    ...
    colorTexture = Utils::loadTexture(RES_DIR "earthspec1kBLUE.jpg");
    normalTexture = Utils::loadTexture(RES_DIR "earthspec1kNORMAL.jpg");
    heightTexture = Utils::loadTexture(RES_DIR "earthspec1kNEG.jpg");
}
