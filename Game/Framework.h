...
class Framework {
  public:
    ...
    static int lua_drawTriangle3DH(lua_State* L);
    static int lua_enableDepthTest(lua_State* L);
    static int lua_enableDepthWrite(lua_State* L);

  private:
    static luaL_Reg lua_reg[20];
};