...
void Event::wait() const { WaitForSingleObject(mImpl->mHandle, INFINITE); }

bool Event::isSet() const { return (WaitForSingleObject(mImpl->mHandle, 0) == WAIT_OBJECT_0); }

void Event::set() { SetEvent(mImpl->mHandle); }

void Event::reset() { ResetEvent(mImpl->mHandle); }
